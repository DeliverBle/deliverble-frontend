...
function SEO(props: SEOProps) {
  ...
  return (
    <Head>
      ...
      <meta property="og:site_name" content="DeliverBle" />
      ...
      <meta property="twitter:site" content="DeliverBle" />
      <meta property="twitter:title" content="딜리버블 | 아나운서 쉐도잉으로 키우는 스피치 자신감" />
      <meta
        property="twitter:description"
        content="뉴스 스크립트, 끊어 읽기, 하이라이트, 메모 남기기 등의 기능과 함께 아나운서의 발성, 발음을 따라하고 말하기 자신감을 키워요!"
      />
      <meta property="twitter:image" content="/assets/images/img_thumbnail.png" />
